...
mod unit_tests {
    ...
    fn test_duplicate_active_preserves_existing_state() {
        let (env, _admin, borrower, contract_id, original_credit_limit, original_interest_rate_bps, original_risk_score) =
            setup_with_active_line();
        ...
        assert_eq!(original_credit_line.interest_rate_bps, original_interest_rate_bps);
        ...
        assert_eq!(credit_line_after_failure.borrower, original_credit_line.borrower);
        assert_eq!(credit_line_after_failure.credit_limit, original_credit_line.credit_limit);
        assert_eq!(credit_line_after_failure.utilized_amount, original_credit_line.utilized_amount);
        assert_eq!(credit_line_after_failure.interest_rate_bps, original_credit_line.interest_rate_bps);
        assert_eq!(credit_line_after_failure.risk_score, original_credit_line.risk_score);
        assert_eq!(credit_line_after_failure.status, original_credit_line.status);
        assert_eq!(credit_line_after_failure.last_rate_update_ts, original_credit_line.last_rate_update_ts);
    }
    ...
    fn test_reopen_closed_credit_line_with_new_parameters() {
        ...
        assert_eq!(closed_credit_line.interest_rate_bps, original_interest_rate_bps);
        ...
        client.open_credit_line(&borrower, &new_credit_limit, &new_interest_rate_bps, &new_risk_score);
        ...
        assert_eq!(reopened_credit_line.credit_limit, new_credit_limit, "credit_limit should be replaced with new value");
        assert_eq!(reopened_credit_line.interest_rate_bps, new_interest_rate_bps, "interest_rate_bps should be replaced with new value");
        assert_eq!(reopened_credit_line.risk_score, new_risk_score, "risk_score should be replaced with new value");
        assert_eq!(reopened_credit_line.status, CreditStatus::Active, "status should be set to Active");
        assert_eq!(reopened_credit_line.utilized_amount, 0, "utilized_amount should be reset to zero");
        assert_eq!(reopened_credit_line.last_rate_update_ts, 0, "last_rate_update_ts should be reset to zero");
    }
    ...
    fn test_reopen_closed_sets_status_to_active() {
        ...
        let closed_credit_line = client.get_credit_line(&borrower).unwrap();
        assert_eq!(closed_credit_line.status, CreditStatus::Closed, "Initial status should be Closed");
        ...
        let reopened_credit_line = client.get_credit_line(&borrower).unwrap();
        assert_eq!(reopened_credit_line.status, CreditStatus::Active, "Status should be Active after reopening");
    }
    ...
    fn test_reopen_closed_resets_utilized_amount() {
        ...
        assert_eq!(active_credit_line.utilized_amount, draw_amount, "utilized_amount should be non-zero after drawing");
        ...
        let closed_credit_line = client.get_credit_line(&borrower).unwrap();
        assert_eq!(closed_credit_line.status, CreditStatus::Closed, "Status should be Closed");
        assert_eq!(closed_credit_line.utilized_amount, draw_amount, "utilized_amount should be preserved when closing");
        ...
        let reopened_credit_line = client.get_credit_line(&borrower).unwrap();
        assert_eq!(reopened_credit_line.status, CreditStatus::Active, "Status should be Active after reopening");
        assert_eq!(reopened_credit_line.utilized_amount, 0, "utilized_amount should be reset to zero when reopening");
        assert_eq!(reopened_credit_line.credit_limit, new_credit_limit, "credit_limit should be updated");
        assert_eq!(reopened_credit_line.interest_rate_bps, new_interest_rate_bps, "interest_rate_bps should be updated");
        assert_eq!(reopened_credit_line.risk_score, new_risk_score, "risk_score should be updated");
    }
    ...
    fn test_reopen_closed_emits_opened_event() {
        ...
        let reopened_credit_line = client.get_credit_line(&borrower).unwrap();
        assert_eq!(reopened_credit_line.status, CreditStatus::Active, "Status should be Active");
        assert_eq!(reopened_credit_line.credit_limit, new_credit_limit, "credit_limit should match new value");
        assert_eq!(reopened_credit_line.interest_rate_bps, new_interest_rate_bps, "interest_rate_bps should match new value");
        assert_eq!(reopened_credit_line.risk_score, new_risk_score, "risk_score should match new value");
    }
    ...
    fn test_reopen_closed_resets_last_rate_update_ts() {
        ...
        assert_eq!(initial_credit_line.last_rate_update_ts, 0, "Initial last_rate_update_ts should be zero");
        ...
        let new_interest_rate_bps = 500_u32;
        client.update_risk_parameters(&borrower, &credit_limit, &new_interest_rate_bps, &risk_score);
        ...
        assert_eq!(
            updated_credit_line.last_rate_update_ts,
            1000,
        ...
        assert_eq!(closed_credit_line.status, CreditStatus::Closed, "Status should be Closed");
        assert_eq!(
            closed_credit_line.last_rate_update_ts,
        ...
        let new_risk_score = 80_u32;
        client.open_credit_line(&borrower, &new_credit_limit, &new_interest_rate_bps_reopen, &new_risk_score);
        ...
        assert_eq!(reopened_credit_line.credit_limit, new_credit_limit, "credit_limit should be updated");
        assert_eq!(reopened_credit_line.interest_rate_bps, new_interest_rate_bps_reopen, "interest_rate_bps should be updated");
        assert_eq!(reopened_credit_line.risk_score, new_risk_score, "risk_score should be updated");
        assert_eq!(reopened_credit_line.utilized_amount, 0, "utilized_amount should be reset to zero");
    }
    ...
    fn test_reopen_suspended_credit_line_with_new_parameters() {
        ...
        assert_eq!(suspended_credit_line.interest_rate_bps, original_interest_rate_bps);
    ...
    fn test_reopen_suspended_sets_status_to_active() {
        ...
        let suspended_credit_line = client.get_credit_line(&borrower).unwrap();
        assert_eq!(suspended_credit_line.status, CreditStatus::Suspended, "Initial status should be Suspended");
    ...
    fn test_reopen_suspended_resets_utilized_amount() {
        ...
        let suspended_credit_line = client.get_credit_line(&borrower).unwrap();
        assert_eq!(suspended_credit_line.status, CreditStatus::Suspended, "Status should be Suspended");
        assert_eq!(suspended_credit_line.utilized_amount, draw_amount, "utilized_amount should be preserved when suspending");
    ...
    fn test_reopen_suspended_resets_last_rate_update_ts() {
        ...
        assert_eq!(suspended_credit_line.status, CreditStatus::Suspended, "Status should be Suspended");
        assert_eq!(
            suspended_credit_line.last_rate_update_ts,
            previous_last_rate_update_ts,
    ...
    fn test_reopen_defaulted_credit_line_with_new_parameters() {
        ...
        assert_eq!(defaulted_credit_line.interest_rate_bps, original_interest_rate_bps);
    ...
    fn test_reopen_defaulted_sets_status_to_active() {
        ...
        let defaulted_credit_line = client.get_credit_line(&borrower).unwrap();
        assert_eq!(defaulted_credit_line.status, CreditStatus::Defaulted, "Initial status should be Defaulted");
    ...
    fn test_reopen_defaulted_resets_utilized_amount() {
        ...
        let defaulted_credit_line = client.get_credit_line(&borrower).unwrap();
        assert_eq!(defaulted_credit_line.status, CreditStatus::Defaulted, "Status should be Defaulted");
        assert_eq!(defaulted_credit_line.utilized_amount, draw_amount, "utilized_amount should be preserved when defaulting");
    ...
    fn test_reopen_defaulted_resets_last_rate_update_ts() {
        ...
        assert_eq!(defaulted_credit_line.status, CreditStatus::Defaulted, "Status should be Defaulted");
        assert_eq!(
            defaulted_credit_line.last_rate_update_ts,
            previous_last_rate_update_ts,
    ...
    fn test_zero_credit_limit_rejection() {
        ...
        client.open_credit_line(&borrower, &zero_credit_limit, &interest_rate_bps, &risk_score);
    }
    ...
    fn test_negative_credit_limit_rejection() {
        ...
        client.open_credit_line(&borrower, &negative_credit_limit, &interest_rate_bps, &risk_score);
    }
    ...
    fn test_excessive_interest_rate_bps_rejection() {
        ...
        client.open_credit_line(&borrower, &credit_limit, &excessive_interest_rate_bps, &risk_score);
    }
    ...
    fn test_excessive_risk_score_rejection() {
        ...
        client.open_credit_line(&borrower, &credit_limit, &interest_rate_bps, &excessive_risk_score);
    }
    ...
    fn test_validation_failure_preserves_existing_state() {
        ...
        client.open_credit_line(&borrower, &original_credit_limit, &original_interest_rate_bps, &original_risk_score);
        ...
        assert_eq!(credit_line_after_invalid_limit.borrower, original_credit_line.borrower);
        assert_eq!(credit_line_after_invalid_limit.credit_limit, original_credit_line.credit_limit);
        assert_eq!(credit_line_after_invalid_limit.utilized_amount, original_credit_line.utilized_amount);
        assert_eq!(credit_line_after_invalid_limit.interest_rate_bps, original_credit_line.interest_rate_bps);
        assert_eq!(credit_line_after_invalid_limit.risk_score, original_credit_line.risk_score);
        assert_eq!(credit_line_after_invalid_limit.status, original_credit_line.status);
        assert_eq!(credit_line_after_invalid_limit.last_rate_update_ts, original_credit_line.last_rate_update_ts);

        // Test 2: Attempt to reopen with invalid interest_rate_bps (> 10000)
        let result = std::panic::catch_unwind(std::panic::AssertUnwindSafe(|| {
            client.open_credit_line(&borrower, &2000_i128, &10001_u32, &80_u32);
        }));
        assert!(result.is_err(), "Expected invalid interest_rate_bps to fail");
        ...
        assert_eq!(credit_line_after_invalid_rate.borrower, original_credit_line.borrower);
        assert_eq!(credit_line_after_invalid_rate.credit_limit, original_credit_line.credit_limit);
        assert_eq!(credit_line_after_invalid_rate.utilized_amount, original_credit_line.utilized_amount);
        assert_eq!(credit_line_after_invalid_rate.interest_rate_bps, original_credit_line.interest_rate_bps);
        assert_eq!(credit_line_after_invalid_rate.risk_score, original_credit_line.risk_score);
        assert_eq!(credit_line_after_invalid_rate.status, original_credit_line.status);
        assert_eq!(credit_line_after_invalid_rate.last_rate_update_ts, original_credit_line.last_rate_update_ts);
        ...
        assert_eq!(credit_line_after_invalid_score.borrower, original_credit_line.borrower);
        assert_eq!(credit_line_after_invalid_score.credit_limit, original_credit_line.credit_limit);
        assert_eq!(credit_line_after_invalid_score.utilized_amount, original_credit_line.utilized_amount);
        assert_eq!(credit_line_after_invalid_score.interest_rate_bps, original_credit_line.interest_rate_bps);
        assert_eq!(credit_line_after_invalid_score.risk_score, original_credit_line.risk_score);
        assert_eq!(credit_line_after_invalid_score.status, original_credit_line.status);
        assert_eq!(credit_line_after_invalid_score.last_rate_update_ts, original_credit_line.last_rate_update_ts);
    }
    ...
    fn test_reopening_replaces_all_parameters() {
        ...
        for status in statuses {
            ...
            assert_eq!(existing_credit_line.status, status, "Initial status should match");
            assert_eq!(existing_credit_line.credit_limit, original_credit_limit);
            assert_eq!(existing_credit_line.interest_rate_bps, original_interest_rate_bps);
    ...
    fn test_reopening_resets_nonzero_utilized_amount() {
        ...
        for status in statuses {
            ...
            let active_credit_line = client.get_credit_line(&borrower).unwrap();
            assert_eq!(
                active_credit_line.utilized_amount,
                draw_amount,
            ...
            assert_eq!(
                status_credit_line.status,
                status,
                "Status should be {:?}",
                status
            );
            assert_eq!(
                status_credit_line.utilized_amount,
                draw_amount,
    ...
    fn test_reopening_resets_nonzero_last_rate_update_ts() {
        ...
        for status in statuses {
            ...
            let initial_credit_line = client.get_credit_line(&borrower).unwrap();
            assert_eq!(
                initial_credit_line.last_rate_update_ts,
                0,
            ...
            client.update_risk_parameters(&borrower, &credit_limit, &updated_interest_rate_bps, &risk_score);
            ...
            assert_eq!(
                status_credit_line.last_rate_update_ts,
                previous_last_rate_update_ts,
